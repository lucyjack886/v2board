                                ...
                                <table width="100%" cellpadding="0" cellspacing="0"
                                    ...
                                    <tr
                                        ...
                                        <td class="content-block"
                                            ...
                                            valign="top">
                                            系统检测到您有一笔订单尚未完成支付（可能仍在待支付，或已因超时取消）。<br />
                                            订单号：<strong>{{$trade_no}}</strong><br />
                                            金额：<strong>¥{{$amount}}</strong><br /><br />
